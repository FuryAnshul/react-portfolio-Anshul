...
import profilePic from "../assets/Anshul-Pass.jpg";
...
const Hero = () => {
	return (
		<div className="border-b border-neutral-900 px-4 lg:mb-35">
				...
				<div className="w-full lg:w-1/2">
					<div className="flex flex-col items-center lg:items-start">
						<motion.h1
							...
							initial="hidden"
							animate="visible"
							className="pd-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-7xl text-center lg:text-left">Anshul Ramdham</motion.h1>
						<motion.span
							variants={container(0.5)}
							initial="hidden"
							animate="visible"
